import React, { ComponentType, ComponentProps, useEffect, useRef } from 'react';
import { NextComponentType } from 'next';

import useHook1 from '@/project2/hooks/useHook1';
import useHook2 from '@/project2/hooks/useHook2';
